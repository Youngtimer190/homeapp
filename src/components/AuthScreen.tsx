...
export default function AuthScreen({ onSuccess, onDemoMode }: Props) {
  ...
  return (
      <div className="bg-gradient-to-br from-indigo-50 via-white to-violet-50 flex flex-col items-center w-full p-3 sm:p-4 safe-top safe-bottom" style={{ paddingTop: `calc(env(safe-area-inset-top) + 0.5rem)`, paddingBottom: `calc(env(safe-area-inset-bottom) + 0.5rem)` }}>
