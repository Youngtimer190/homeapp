...
export default function AuthScreen({ onSuccess, onDemoMode }: Props) {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-50 via-white to-violet-50 flex items-start justify-center p-3 sm:p-4 overflow-y-auto min-h-screen" style={{ paddingTop: `calc(env(safe-area-inset-top) + 2rem)`, paddingBottom: `calc(env(safe-area-inset-bottom) + 1rem)` }}>
